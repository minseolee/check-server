...
function SlotUsing(props) {
    ...
    useEffect(() => {
        ...
        axiosInstance.post('/api/slot/getSlots', memberVariables)
            .then(response => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (extend) =>
            {
                if(extend[1]) {
                    return (
                        <Tooltip title="연장신청완료">
                            <Button>
                                <Icon type="check" style={{color: "green", fontWeight: "bold"}} />
                            </Button>
                        </Tooltip>
                    )
                } else {
                    return (
                        <Button value={extend[0]} onClick={onExtendClick} style={{color: "green", fontWeight: "bold"}}>
                            <Icon type="plus" />
                        </Button>
                    )
                }
